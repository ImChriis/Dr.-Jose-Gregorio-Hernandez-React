...
const Navbar: React.FC = () => {
    return (
        <>
            <nav className='w-full flex flex-row justify-between items-center fixed top-0 left-0 z-50 bg-[#121212] bg-opacity-80 backdrop-blur-md py-2'>
                <div className='flex items-center space-x-2 ml-4'>
                    <a href="#welcome">
                        <img src={Logo} alt="Logo" className='w-12 rounded-full object-cover' />
                    </a>
                    <a href="#welcome" className='font-semibold text-lg'>José Gregorio Hernández</a>
                </div>
                 ...
                 <ul className="flex space-x-4 mr-4">
                    ...
                    <li><a href="#santification" className="text-white hover:text-gray-400">Santificación</a></li>
                    ...
                    <li><a href="#prayer" className="text-white hover:text-gray-400">Oración</a></li>
                </ul>
            </nav>
        </>
    )
